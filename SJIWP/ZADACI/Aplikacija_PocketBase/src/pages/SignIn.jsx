                ...
                <div class="w-full bg-gray-800 rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" onSubmit={handleLogin}>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input
                                            type="checkbox"
                                            class="w-4 h-4 border rounded bg-gray-700 border-gray-600 focus:ring-3 focus:ring-primary-600 ring-offset-gray-800"
                                        />
                                    </div>
                                ...
                                <a href="#" class="text-white hover:text-info text-sm font-medium hover:underline">Zaboravljena lozinka?</a>
                            </div>
                            ...
                            <button
                                type="submit"
                                class="w-full bg-indigo-700 hover:bg-indigo-600 text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                disabled={loading()}
                            >
                            ...
                            <p class="text-sm font-light text-gray-400">
                                Nemate račun? <a href="/signup" class="font-medium hover:underline text-white hover:text-info">Registracija</a>
                            </p>
                        </form>
                    </div>
                </div>
